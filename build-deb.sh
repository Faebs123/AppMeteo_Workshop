...
mkdir -p "$BUILD_DIR/com/example/weather" \
        "$BUILD_DIR/com/example/weather/shared/model" \
        "$BUILD_DIR/com/example/weather/shared/service" \
        "$BUILD_DIR/com/example/weather/shared/widget" \
        "$BUILD_DIR/com/example/weather/app/view" \
        "$BUILD_DIR/com/example/weather/app/controller" \
        "$BUILD_DIR/com/example/weather/search/view" \
        "$BUILD_DIR/com/example/weather/current/view" \
        "$BUILD_DIR/com/example/weather/forecast/view"
...
cat > "$BUILD_DIR/com/example/weather/shared/model/WeatherData.java" << 'JAVAEOF'
...
cat > "$BUILD_DIR/com/example/weather/shared/model/DailyData.java" << 'JAVAEOF'
package com.example.weather.shared.model;

public record DailyData(String date, double tempMax, double tempMin, double windMax) {}
JAVAEOF

cat > "$BUILD_DIR/com/example/weather/shared/model/GeocodeResult.java" << 'JAVAEOF'
package com.example.weather.shared.model;

public record GeocodeResult(String cityName, String country, double lat, double lon) {}
JAVAEOF

cat > "$BUILD_DIR/com/example/weather/shared/service/WeatherService.java" << 'JAVAEOF'
...
cat > "$BUILD_DIR/com/example/weather/shared/service/OpenMeteoService.java" << 'JAVAEOF'
package com.example.weather.shared.service;
...
cat > "$BUILD_DIR/com/example/weather/shared/widget/StyledButton.java" << 'JAVAEOF'
...
cat > "$BUILD_DIR/com/example/weather/shared/widget/GradientPanel.java" << 'JAVAEOF'
package com.example.weather.shared.widget;
...
cat > "$BUILD_DIR/com/example/weather/shared/widget/RoundedPanel.java" << 'JAVAEOF'
package com.example.weather.shared.widget;
...
cat > "$BUILD_DIR/com/example/weather/shared/widget/ChartPanel.java" << 'JAVAEOF'
package com.example.weather.shared.widget;
...
cat > "$BUILD_DIR/com/example/weather/app/view/MainFrame.java" << 'JAVAEOF'
...
cat > "$BUILD_DIR/com/example/weather/app/controller/WeatherController.java" << 'JAVAEOF'
...
cat > "$BUILD_DIR/com/example/weather/search/view/HomePanel.java" << 'JAVAEOF'
...
cat > "$BUILD_DIR/com/example/weather/current/view/CurrentPanel.java" << 'JAVAEOF'
...
cat > "$BUILD_DIR/com/example/weather/forecast/view/ForecastPanel.java" << 'JAVAEOF'
...
javac -d "$BUILD_DIR/classes" -cp "$JACKSON_LIBS" \
    $(find "$BUILD_DIR/com/example/weather" -name "*.java")
